...
class ListSessionsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$0.Session>(1, _omitFieldNames ? '' : 'session', $pb.PbFieldType.PM,
        subBuilder: $0.Session.create)
...
class InvalidateAllSessionsResponse extends $pb.GeneratedMessage {
  ...
  factory InvalidateAllSessionsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory InvalidateAllSessionsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'InvalidateAllSessionsResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'namespace.private.sessions.v1beta'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  InvalidateAllSessionsResponse clone() =>
      InvalidateAllSessionsResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  InvalidateAllSessionsResponse copyWith(
          void Function(InvalidateAllSessionsResponse) updates) =>
      super.copyWith(
              (message) => updates(message as InvalidateAllSessionsResponse))
          as InvalidateAllSessionsResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static InvalidateAllSessionsResponse create() =>
      InvalidateAllSessionsResponse._();
  @$core.override
  InvalidateAllSessionsResponse createEmptyInstance() => create();
  static $pb.PbList<InvalidateAllSessionsResponse> createRepeated() =>
      $pb.PbList<InvalidateAllSessionsResponse>();
  @$core.pragma('dart2js:noInline')
  static InvalidateAllSessionsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InvalidateAllSessionsResponse>(create);
...
class IssueTenantTokenFromSessionRequest extends $pb.GeneratedMessage {
  ...
  factory IssueTenantTokenFromSessionRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory IssueTenantTokenFromSessionRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'IssueTenantTokenFromSessionRequest',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'namespace.private.sessions.v1beta'),
      createEmptyInstance: create)
    ..aOM<$1.Duration>(1, _omitFieldNames ? '' : 'tokenDuration',
        subBuilder: $1.Duration.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  IssueTenantTokenFromSessionRequest clone() =>
      IssueTenantTokenFromSessionRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  IssueTenantTokenFromSessionRequest copyWith(
          void Function(IssueTenantTokenFromSessionRequest) updates) =>
      super.copyWith((message) =>
              updates(message as IssueTenantTokenFromSessionRequest))
          as IssueTenantTokenFromSessionRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static IssueTenantTokenFromSessionRequest create() =>
      IssueTenantTokenFromSessionRequest._();
  @$core.override
  IssueTenantTokenFromSessionRequest createEmptyInstance() => create();
  static $pb.PbList<IssueTenantTokenFromSessionRequest> createRepeated() =>
      $pb.PbList<IssueTenantTokenFromSessionRequest>();
  @$core.pragma('dart2js:noInline')
  static IssueTenantTokenFromSessionRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<IssueTenantTokenFromSessionRequest>(
          create);
...
class IssueTenantTokenFromSessionResponse extends $pb.GeneratedMessage {
  ...
  factory IssueTenantTokenFromSessionResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory IssueTenantTokenFromSessionResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'IssueTenantTokenFromSessionResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'namespace.private.sessions.v1beta'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  IssueTenantTokenFromSessionResponse clone() =>
      IssueTenantTokenFromSessionResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  IssueTenantTokenFromSessionResponse copyWith(
          void Function(IssueTenantTokenFromSessionResponse) updates) =>
      super.copyWith((message) =>
              updates(message as IssueTenantTokenFromSessionResponse))
          as IssueTenantTokenFromSessionResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static IssueTenantTokenFromSessionResponse create() =>
      IssueTenantTokenFromSessionResponse._();
  @$core.override
  IssueTenantTokenFromSessionResponse createEmptyInstance() => create();
  static $pb.PbList<IssueTenantTokenFromSessionResponse> createRepeated() =>
      $pb.PbList<IssueTenantTokenFromSessionResponse>();
  @$core.pragma('dart2js:noInline')
  static IssueTenantTokenFromSessionResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          IssueTenantTokenFromSessionResponse>(create);
...
class UserSessionsServiceApi {
  ...
  $async.Future<ListSessionsResponse> listSessions(
      ...
      _client.invoke<ListSessionsResponse>(ctx, 'UserSessionsService',
          'ListSessions', request, ListSessionsResponse());
  $async.Future<$2.Empty> invalidateSession(
          $pb.ClientContext? ctx, InvalidateSessionRequest request) =>
      _client.invoke<$2.Empty>(
          ctx, 'UserSessionsService', 'InvalidateSession', request, $2.Empty());
  $async.Future<InvalidateAllSessionsResponse> invalidateAllSessions(
          $pb.ClientContext? ctx, $2.Empty request) =>
      _client.invoke<InvalidateAllSessionsResponse>(ctx, 'UserSessionsService',
          'InvalidateAllSessions', request, InvalidateAllSessionsResponse());
  $async.Future<IssueTenantTokenFromSessionResponse>
      issueTenantTokenFromSession($pb.ClientContext? ctx,
              IssueTenantTokenFromSessionRequest request) =>
          _client.invoke<IssueTenantTokenFromSessionResponse>(
              ctx,
              'UserSessionsService',
              'IssueTenantTokenFromSession',
              request,
              IssueTenantTokenFromSessionResponse());
}
